...
if (
  ...
  throw new Error(
    'Coverage baseline catalog count must remain 381.',
  )
}
...
if (
  ...
  throw new Error(
    `Expected 239 direct test signals; found ${baseline.directTestSignals}.`,
  )
}
...
console.log(
  'Direct test signals: 207',
)

console.log(
  'Remaining tracked coverage gaps: 173',
)
