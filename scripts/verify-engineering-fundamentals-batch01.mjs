...
if (
  ...
  throw new Error(
    'Coverage baseline catalog count must remain 384.',
  )
}
...
if (
  ...
  throw new Error(
    `Expected 242 direct test signals; found ${baseline.directTestSignals}.`,
  )
}
...
console.log(
  'Direct test signals: 242',
)

console.log(
  'Remaining tracked coverage gaps: 142',
)
