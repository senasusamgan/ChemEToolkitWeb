...
if (entries.length !== 380 || live !== 236) {
  console.error(
...
if (
  !/name:\s*"Numerical Methods"[^{}]*total:\s*40[^{}]*live:\s*16/s.test(
    categories,
  )
) {
  console.error(
    'Numerical Methods count is not 16 / 40.',
  )
  process.exit(1)
}

console.log('Numerical Methods Batch 01 verification PASS')
console.log('380 total / 236 live / 144 queued')
console.log('Numerical Methods: 16 live / 40 total')
