...
if (entries.length !== 380 || live !== 225) {
  console.error(
...
if (
  !/name:\s*"Separation Processes"[^{}]*total:\s*40[^{}]*live:\s*35/s.test(
    categories,
  )
) {
  console.error(
    'Separation Processes count is not 35 / 40.',
  )
  process.exit(1)
}

console.log('Separation Batch 04 verification PASS')
console.log('380 total / 225 live / 155 queued')
console.log('Separation Processes: 35 live / 40 total')
