...
if (
  !categories.includes(
    'name: "Separation Processes", icon: "⋈", total: 41, live: 41',
  )
) {
  throw new Error(
    'Separation Processes metadata is not 41/41.',
  )
}
...
if (
  ...
  throw new Error(
    'Catalog verifier does not expect 41 Separation calculators.',
  )
}
