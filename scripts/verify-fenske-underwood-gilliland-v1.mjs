...
if (
  !categories.includes(
    'name: "Separation Processes", icon: "⋈", total: 43, live: 43',
  )
) {
  throw new Error(
    'Separation Processes metadata is not 43/43.',
  )
}
...
if (
  ...
  throw new Error(
    'Catalog verifier does not expect 43 Separation calculators.',
  )
}
...
if (
  ...
  throw new Error(
    'Coverage baseline calculator count is not 383.',
  )
}
