...
if (
  !categories.includes(
    'name: "Separation Processes", icon: "⋈", total: 45, live: 45',
  )
) {
  throw new Error(
    'Separation Processes metadata is not 45/45.',
  )
}
...
if (
  ...
  throw new Error(
    'Catalog verifier does not expect 45 Separation calculators.',
  )
}
...
if (
  ...
  throw new Error(
    'Coverage baseline calculator count is not 385.',
  )
}
