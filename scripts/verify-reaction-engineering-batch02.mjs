...
if (categoryLive !== 22) {
  console.error(
    `Reaction Engineering live count is ${categoryLive}, expected 22.`,
  )
  process.exit(1)
}
...
if (
  ...
  console.error(
    'Reaction Engineering category is not 22 / 62.',
  )
  process.exit(1)
}
...
console.log(
  'Reaction Engineering Batch 02 verification PASS',
)
console.log(
  '380 total / 340 live / 40 queued',
)
console.log(
  'Reaction Engineering: 22 live / 62 total',
)
