...
if (entries.length !== 380 || live !== 207) {
  console.error(
...
if (
  !/name:\s*"Separation Processes"[^{}]*total:\s*40[^{}]*live:\s*17/s.test(
    categories,
  )
) {
  console.error(
    'Separation Processes count is not 17 / 40.',
  )
  process.exit(1)
}

console.log('Separation Batch 01 verification PASS')
console.log('380 total / 207 live / 173 queued')
console.log('Separation Processes: 17 live / 40 total')
