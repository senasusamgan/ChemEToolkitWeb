...
if (
  !categories.includes(
    'name: "Separation Processes", icon: "⋈", total: 42, live: 42',
  )
) {
  throw new Error(
    'Separation Processes metadata is not 42/42.',
  )
}
...
if (
  ...
  throw new Error(
    'Catalog verifier does not expect 42 Separation calculators.',
  )
}
...
if (
  ...
  throw new Error(
    'Coverage baseline calculator count is not 382.',
  )
}
