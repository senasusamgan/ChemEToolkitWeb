...
if (
  !categories.includes(
    'name: "Separation Processes", icon: "⋈", total: 44, live: 44',
  )
) {
  throw new Error(
    'Separation Processes metadata is not 44/44.',
  )
}
...
if (
  ...
  throw new Error(
    'Catalog verifier does not expect 44 Separation calculators.',
  )
}
...
if (
  ...
  throw new Error(
    'Coverage baseline calculator count is not 384.',
  )
}
