...
if (categoryLive !== 62) {
  console.error(
    `Reaction Engineering live count is ${categoryLive}, expected 62.`,
  )
  process.exit(1)
}
...
if (
  ...
  console.error(
    'Reaction Engineering category is not 62 / 62.',
  )
  process.exit(1)
}
...
console.log(
  'Reaction Engineering Batch 09 FINAL verification PASS',
)
console.log(
  '380 total / 380 live / 0 queued',
)
console.log(
  'Reaction Engineering: 62 live / 62 total — COMPLETE',
)
