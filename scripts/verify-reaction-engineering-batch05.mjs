...
if (categoryLive !== 40) {
  console.error(
    `Reaction Engineering live count is ${categoryLive}, expected 40.`,
  )
  process.exit(1)
}
...
if (
  ...
  console.error(
    'Reaction Engineering category is not 40 / 62.',
  )
  process.exit(1)
}
...
console.log(
  'Reaction Engineering Batch 05 verification PASS',
)
console.log(
  '380 total / 358 live / 22 queued',
)
console.log(
  'Reaction Engineering: 40 live / 62 total',
)
