...
if (entries.length !== 380 || live !== 260) {
  console.error(
...
if (
  !/name:\s*"Numerical Methods"[^{}]*total:\s*40[^{}]*live:\s*40/s.test(
    categories,
  )
) {
  console.error(
    'Numerical Methods count is not 40 / 40.',
  )
  process.exit(1)
}

console.log('Numerical Methods Batch 05 Final verification PASS')
console.log('380 total / 260 live / 120 queued')
console.log('Numerical Methods: 40 live / 40 total — COMPLETE')
