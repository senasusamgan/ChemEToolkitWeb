...
if (entries.length !== 380 || live !== 254) {
  console.error(
...
if (
  !/name:\s*"Numerical Methods"[^{}]*total:\s*40[^{}]*live:\s*34/s.test(
    categories,
  )
) {
  console.error(
    'Numerical Methods count is not 34 / 40.',
  )
  process.exit(1)
}

console.log('Numerical Methods Batch 04 verification PASS')
console.log('380 total / 254 live / 126 queued')
console.log('Numerical Methods: 34 live / 40 total')
