...
if (entries.length !== 380 || live !== 230) {
  console.error(
...
if (
  !/name:\s*"Separation Processes"[^{}]*total:\s*40[^{}]*live:\s*40/s.test(
    categories,
  )
) {
  console.error(
    'Separation Processes count is not 40 / 40.',
  )
  process.exit(1)
}

console.log('Separation Batch 05 Final verification PASS')
console.log('380 total / 230 live / 150 queued')
console.log('Separation Processes: 40 live / 40 total — COMPLETE')
