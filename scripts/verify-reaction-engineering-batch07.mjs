...
if (categoryLive !== 52) {
  console.error(
    `Reaction Engineering live count is ${categoryLive}, expected 52.`,
  )
  process.exit(1)
}
...
if (
  ...
  console.error(
    'Reaction Engineering category is not 52 / 62.',
  )
  process.exit(1)
}
...
console.log(
  'Reaction Engineering Batch 07 verification PASS',
)
console.log(
  '380 total / 370 live / 10 queued',
)
console.log(
  'Reaction Engineering: 52 live / 62 total',
)
