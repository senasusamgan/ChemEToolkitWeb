...
import type { GaussNewtonNonlinearRegressionResult } from './types'
import {
  ActionBar,
  CalculatorHeader,
  NumericInput,
...
export function GaussNewtonNonlinearRegressionCalculator() {
  ...
  const [result, setResult] =
    useState<GaussNewtonNonlinearRegressionResult | null>(null)
  const [errorMessage, setErrorMessage] = useState('')

  function calculate() {
    try {
      setResult(calculateGaussNewtonNonlinearRegression({
  ...
  return (
    <section className="native-calculator">
      <CalculatorHeader
        ...
        subtitle="Iterative exponential-model fitting for four observations"
      />

      <ReferenceBasis>
        Nonlinear least squares for y = a exp(bx)
      </ReferenceBasis>
      ...
      <ActionBar onLoadExample={loadExample} onClear={clearInputs} onCalculate={calculate} calculateLabel="Fit exponential model" />
