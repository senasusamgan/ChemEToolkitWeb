...
export function CalculatorWorkbench({
  ...
  if (calculatorId === 'trapezoidalChannelGvfProfileRk4') {
    return <TrapezoidalChannelGvfProfileRk4Calculator />
  }

  if (calculatorId === 'trapezoidalMaximumDischargeSpecificEnergy') {
    return <TrapezoidalMaximumDischargeSpecificEnergyCalculator />
  }

  if (calculatorId === 'trapezoidalCriticalControlWidth') {
  ...
  if (calculatorId === 'trapezoidalMinimumUpstreamDepthBedRise') {
    return <TrapezoidalMinimumUpstreamDepthBedRiseCalculator />
  }

  if (calculatorId === 'trapezoidalMinimumContractionWidth') {
    return <TrapezoidalMinimumContractionWidthCalculator />
  }

  if (calculatorId === 'trapezoidalContractionThroatAnalysis') {
    return <TrapezoidalContractionThroatAnalysisCalculator />
  }

  if (calculatorId === 'trapezoidalContractionTransitionLoss') {
    return <TrapezoidalContractionTransitionLossCalculator />
  }

  if (calculatorId === 'trapezoidalMaximumTransitionLossCoefficient') {
  ...
  if (calculatorId === 'trapezoidalMaximumBedRiseContractionLoss') {
    return <TrapezoidalMaximumBedRiseContractionLossCalculator />
  }

  if (calculatorId === 'trapezoidalMinimumWidthBedRiseTransitionLoss') {
    return <TrapezoidalMinimumWidthBedRiseTransitionLossCalculator />
  }

  if (calculatorId === 'trapezoidalMaximumDischargeBedRiseTransitionLoss') {
    return <TrapezoidalMaximumDischargeBedRiseTransitionLossCalculator />
  }

  if (calculatorId === 'trapezoidalMaximumTransitionLossCoefficientBedRise') {
    return <TrapezoidalMaximumTransitionLossCoefficientBedRiseCalculator />
  }

  if (calculatorId === 'trapezoidalMinimumUpstreamDepthBedRiseTransitionLoss') {
  ...
  if (calculatorId === 'trapezoidalChannelAdaptiveStandardStepProfile') {
    return <TrapezoidalChannelAdaptiveStandardStepProfileCalculator />
  }

  if (calculatorId === 'trapezoidalChannelUpstreamStandardStepProfile') {
    return <TrapezoidalChannelUpstreamStandardStepProfileCalculator />
  }

  if (calculatorId === 'trapezoidalChannelAdaptiveUpstreamStandardStepProfile') {
    return <TrapezoidalChannelAdaptiveUpstreamStandardStepProfileCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelManningFlow') {
  ...
  if (calculatorId === 'partiallyFullCircularChannelAlternateDepths') {
    return <PartiallyFullCircularChannelAlternateDepthsCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelCriticalSlope') {
    return <PartiallyFullCircularChannelCriticalSlopeCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelHydraulicJump') {
    return <PartiallyFullCircularChannelHydraulicJumpCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelDirectStep') {
    return <PartiallyFullCircularChannelDirectStepCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelGvfSlope') {
    return <PartiallyFullCircularChannelGvfSlopeCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelGvfProfile') {
    return <PartiallyFullCircularChannelGvfProfileCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelAdaptiveGvfProfile') {
    return <PartiallyFullCircularChannelAdaptiveGvfProfileCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelStandardStep') {
  ...
  if (calculatorId === 'partiallyFullCircularChannelUpstreamStandardStepProfile') {
  ...
  if (calculatorId === 'partiallyFullCircularChannelMinimumDiameterSpecificEnergy') {
    return <PartiallyFullCircularChannelMinimumDiameterSpecificEnergyCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelMinimumRequiredSpecificEnergy') {
    return <PartiallyFullCircularChannelMinimumRequiredSpecificEnergyCalculator />
  }

  if (calculatorId === 'partiallyFullCircularChannelCapacityChokingMargin') {
