...
export const categories: CategoryDefinition[] = [
  ...
  { number: 4, name: "Mass Transfer", icon: "⠿", total: 45, live: 42 },
  { number: 5, name: "Material & Energy Balances", icon: "⇄", total: 25, live: 25 },
  { number: 6, name: "Numerical Methods", icon: "ƒ", total: 40, live: 10 },
  ...
  { number: 10, name: "Separation Processes", icon: "⋈", total: 40, live: 11 },
